...
# ==========================================
# 5. CATEGORIZED 3-COLUMN DASHBOARD
# ==========================================
col1, col2, col3 = st.columns(3)

with col1:
    st.markdown("Temporal Logic")
    ...
    st.markdown("<br>Cargo Profile", unsafe_allow_html=True)
...
with col2:
    ...
    st.markdown("<br>Capacity Metrics", unsafe_allow_html=True)
...
with col3:
    st.markdown("Commercials & Reliability")
    ...
    st.markdown("<br>Environmental Risk", unsafe_allow_html=True)
...
if center_col.button("Analyze Route", use_container_width=True):
    ...
    with out_col2:
        ...
        fig = go.Figure(go.Indicator(
            mode = "gauge+number",
            value = score,
            number = {'valueformat': '.4f', 'font': {'size': 36, 'color': gauge_color, 'family': 'monospace'}},
            domain = {'x': [0, 1], 'y': [0, 1]},
            title = {'text': "ROUTE OPTIMIZATION LEVEL", 'font': {'size': 18, 'color': '#ffffff', 'family': 'monospace, sans-serif'}},
            gauge = {
